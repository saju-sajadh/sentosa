...
python src/s5_test.py \deactivate
...
def get_command_line_arguments():
    ...
    def parse_args():
        ...
        parser.add_argument("-d", "--mode", required=False, default='action',
                    choices=["action", "face", "emotion"],
                    help="Choose the mode: 'action' for action recognition, 'face' for face recognition.")
...
if __name__ == "__main__":
    ...
    try:
        ...
        while images_loader.has_image() and getattr(thread, "do_run", True):
                # -- Read image
